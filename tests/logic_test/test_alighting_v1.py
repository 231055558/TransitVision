...
from transit_vision.logic.alighting_counter_v1 import filter_alighting_passengers
import cv2
import numpy as np
...
def test_alighting_v1():
    ...
    with VideoReader(TEST_VIDEO) as reader:
        ...
        out_path = str(OUTPUT_DIR / "alighting_v1.mp4")
        ...
        for frame in reader:
            ...
            cv2.putText(frame, f"V1 Count: {len(alighting)}", (10, 30),
