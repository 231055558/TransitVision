...
from transit_vision.logic.alighting_counter_v3 import filter_alighting_passengers
import cv2
import numpy as np
...
def test_alighting_v3():
    ...
    # 3. 下客判定 (V3算法)
    print(f"\n3. Alighting detection (V3 - Matrix Operation)...")
    ...
    with VideoReader(TEST_VIDEO) as reader:
        ...
        out_path = str(OUTPUT_DIR / "alighting_v3.mp4")
        ...
        for frame in reader:
            ...
            cv2.putText(frame, f"V3 Count: {len(alighting)}", (10, 30),
